    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                <v-dialog v-model="openDialog" width="500">
                    <SuppotingDeliveryDelivery :offline="offline"  :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row class="ma-0 pa-0">
            <v-col class="pa-4" cols="12" sm="6" md="3" v-for="(value, index) in values" :key="index">
                <SuppotingDeliveryDelivery :offline="offline"
...
<script>
    ...
    import SuppotingDeliveryDelivery from './../SuppotingDeliveryDelivery.vue';

    export default {
        name: 'SuppotingDeliveryDeliveryManager',
        components: {
            SuppotingDeliveryDelivery,
        },
        props: {
            offline: Boolean
        },
