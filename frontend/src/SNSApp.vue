            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="deliveries"
                        to="/suppotingDeliveries/deliveries"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="inventories"
                        to="/suppotingDeliveries/inventories"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                key: 'deliveries', 
                route: '/suppotingDeliveries/deliveries',
                ImageUrl: '',
            },
            { 
                title: 'Inventory', 
                ...
                key: 'inventories', 
                route: '/suppotingDeliveries/inventories',
                ImageUrl: '',
            },
            { 
                title: 'MyView', 
